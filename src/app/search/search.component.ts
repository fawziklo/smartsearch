...
export class SearchComponent implements OnInit {
  ...
  onNavigate(file_name: string) {
    window.open("https://stdbsearch78.blob.core.windows.net/content/" + file_name, "_blank");
  }

  async fetchImagePath(metadata_path:string) {
    /* setup blob cors [* verbs * * 1800] */
    let images = []
    const blobSasUrl = "https://stdbsearch78.blob.core.windows.net/?sv=2021-12-02&ss=bfqt&srt=sco&sp=rwdlacupiytfx&se=2024-03-22T00:39:01Z&st=2023-03-20T16:39:01Z&spr=https,http&sig=bSncjP7bvsH7Kef9C4SuydIURcunPu4AB1Ps4y%2FqVTA%3D"
    
    let blobServiceClient = new BlobServiceClient(blobSasUrl)
    const containerClient = blobServiceClient.getContainerClient("azureblob-skillset-image-projection");
    const pred = "https://stdbsearch78.blob.core.windows.net/azureblob-skillset-image-projection/"
